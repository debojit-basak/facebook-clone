...
import NotificationsActionIcon from '@material-ui/icons/NotificationsActive'
    ...
    return (
        <div className="header">
            <div className="header__left">
                ...
                <div className="header__input"><SearchIcon /><input placeholder="Search Facebook" type="text"/></div>
            </div>
